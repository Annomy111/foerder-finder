#!/usr/bin/env python3
"""
Batch-Import mehrerer Stiftungen

Scrapt mehrere Stiftungen mit dem SUPER SCRAPER und importiert
alle gefundenen Programme in die Datenbank.
"""
...
# Liste der Stiftungen zum Scrapen
FOUNDATIONS = [
    {
        "name": "Robert Bosch Stiftung",
        "url": "https://www.bosch-stiftung.de",
        "min_quality": 0.25  # Etwas niedrigerer Threshold für größere Abdeckung
    },
    {
        "name": "Vodafone Stiftung Deutschland",
        "url": "https://www.vodafone-stiftung.de",
        "min_quality": 0.25
    },
    {
    ...
    },
    {
        ...
        "url": "https://koerber-stiftung.de",
        "min_quality": 0.25
    },
    {
        "name": "Deutsche Telekom Stiftung",
        "url": "https://www.telekom-stiftung.de",
        "min_quality": 0.25
    }
]
...
def main():
    print("=" * 80)
    print("BATCH-IMPORT DEUTSCHER STIFTUNGEN")
    print("=" * 80)
    print()
